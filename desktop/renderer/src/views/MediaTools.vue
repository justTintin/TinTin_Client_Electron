...
/* 分组顺序与工具（原客户端 media_tools_page.py：图形/视频/提示词 3 组 8 张 + 混剪/切片入口）
   ...
   /* 2026-09-18 用户裁决：剪映模板卡迁入文案脚本；分组名改为「文案脚本模板」 */
...
const GROUP_TOOLS: Record<string, ToolItem[]> = {
  '文案脚本模板': [
    ...
    // 2026-09-18 用户裁决：剪映模板迁入
    { id: 'jianying-templates', title: '剪映模板', desc: '从剪映同步的预设/文字模板/花字/贴纸/转场/音频，按分类浏览', group: '文案脚本模板', emoji: '🎞️', accent: 'linear-gradient(135deg,#0EA5E9 0%,#8B5CF6 100%)', kind: 'comp', comp: defineAsyncComponent(() => import('@/components/media-tools/JianYingTemplates.vue')) },
  ...
  '视频': [
    ...
    // 2026-09-19 用户要求：新增「文案混剪」卡（建设中占位——功能定义后接真实组件）
    { id: 'copywriting-montage', title: '文案混剪', desc: '按文案自动匹配素材，快速生成混剪成片', group: '视频', emoji: '📝', accent: 'linear-gradient(135deg,#10B981 0%,#0EA5E9 100%)', kind: 'comp', comp: defineAsyncComponent(() => import('@/components/media-tools/copywriting-montage/CopywritingMontage.vue')) },
    { id: 'viral-clone',     title: '仿爆款',     desc: '拆解爆款→复刻脚本→替换本店产品', group: '视频', emoji: '🔥', accent: 'linear-gradient(135deg,#F43F5E 0%,#F59E0B 100%)', kind: 'comp', wip: true, comp: defineAsyncComponent(() => import('@/components/media-tools/ViralClone.vue')) },
    ...
    { id: 'subtitle-removal',  title: '视频去水印字幕', desc: '去除字幕 / 台标水印',  group: '视频', emoji: '🔤', accent: 'linear-gradient(135deg,#F59E0B 0%,#EF4444 100%)', kind: 'comp', wip: true, comp: defineAsyncComponent(() => import('@/components/media-tools/SubtitleRemoval.vue')) },
