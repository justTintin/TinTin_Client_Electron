// ══════════════════════════════════════════════════════════
// useMontageBgmPlayer.ts — 智能混剪 Step4·BGM 试听播放器子编排（铁律 10 E4 收口，2026-09-19）
// 自 useMontageStep4Final.ts 纯搬迁（IRON-02 五项 checklist）。
...
export function useMontageBgmPlayer(ctx: MontageBgmPlayerContext) {
