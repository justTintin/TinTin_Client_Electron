...
const GROUP_TOOLS: Record<string, ToolItem[]> = {
  ...
  '视频': [
    ...
    { id: 'copy-montage', title: '文案混剪', desc: '按文案自动匹配素材，快速生成混剪成片', group: '视频', emoji: '📝', accent: 'linear-gradient(135deg,#10B981 0%,#0EA5E9 100%)', kind: 'comp', comp: defineAsyncComponent(() => import('@/components/media-tools/copy-montage/CopyMontage.vue')) },
