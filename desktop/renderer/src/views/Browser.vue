...
//   · components/browser/BrowserToolbar.vue      工具栏（原 template L1306-1435）
//   · components/browser/BrowserSidebar.vue      左栏（原 L1440-1455）
//   · components/browser/FavoritesView.vue       收藏视图（原 L1503-1565）
//   · components/browser/BrowserRightPanel.vue   右栏双 Tab（原 L1568-1808）
