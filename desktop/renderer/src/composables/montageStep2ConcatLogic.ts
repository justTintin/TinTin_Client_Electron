// ═══════════════════════════════════════════════════════════════
// montageStep2ConcatLogic.ts — 智能混剪 Step2 镜头重组纯逻辑
// 自 videoMontageLogic.ts 拆分（铁律 10 / 2026-09-18，纯搬迁零行为改动，
...
import type { SplitSceneRow } from './montageStep1SplitLogic.ts'
import { applyShotLayoutOrder } from './montageStep1SplitLogic.ts'
