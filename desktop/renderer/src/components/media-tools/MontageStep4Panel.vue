...
// ── BGM 选择弹窗（已迁 MontageBgmPickDialog.vue，铁律 10 P4b 纯搬迁）──
const bgmDlgRef = ref<InstanceType<typeof MontageBgmPickDialog> | null>(null)
...
<div class="vd-split" title="拖动调整左右比例" @mousedown="onSplitDown"></div>
    ...
    <MontageBgmPickDialog ref="bgmDlgRef" />
</template>
