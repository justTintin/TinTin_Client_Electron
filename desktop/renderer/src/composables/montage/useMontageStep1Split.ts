// ═══════════════════════════════════════════════════════════════
// useMontageStep1Split.ts — 智能混剪 Step1 素材解析编排（铁律 10 拆分，2026-09-18）
...
export function useMontageStep1Split(ctx: MontageStep1Context) {
  ...
  const POOL_LS_KEY = 'montage.pool'
  const SRC_LS_KEY = 'montage.srcVideos'
  try {
