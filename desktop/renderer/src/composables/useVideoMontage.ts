...
import {
  ...
  extractSubmitTaskId,
  // Step1 splits 本地缓存（原版 montage_cache 口径）——已随 Step1 迁 useMontageStep1Split
  // Step2 镜头重组·预合成方案
...
// 模块级工具/轮询常量与 Step1 编排已迁 montage/（铁律 10 拆分，纯搬迁，
// 蓝图见 docs/智能混剪拆分迁移映射_2026-09-18.md）
import { POLL_INTERVAL_MS, POLL_TIMEOUT_MS, notify, unwrapIpc, errText, joinPath, type PollChannel } from './montage/context'
...
export function useVideoMontage() {
  ...
  // 确认合成进度（对照原版 montage_concat_server_worker：提交 30/轮询钳 48/完成 100）
